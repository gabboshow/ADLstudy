...
for i = 1:length(UseSystems)
    ...
    [FeatureSet{i} datasps DTable{i}] = repos_loaddata(Repository, Partindex, UseSystems{i}, 'orgsps', 170.7);
%     [FeatureSet{i} datasps DTable{i}] = repos_loaddata_calib(Repository, Partindex, UseSystems{i}, 'orgsps', 170.7);
