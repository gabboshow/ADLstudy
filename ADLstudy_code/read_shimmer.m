...
path_data = '/media/Data/Condiviso/TUe/Datasets/ADL_study/Test_Gabbo/';
date_data = '2014_06_15';
time_data = '10_36';
sensor_data = 'AnkleR';
fs_shimmer = 200;


AnkleR_data= fopen(strcat(path_data,sensor_data,'/',date_data,'/',time_data,'/acceleration/acceltot.bin'));
...
ECG1_data= fopen(strcat(path_data,'ECG1/',date_data,'/',time_data,'/acceleration/acceltot.bin'));
...
ECG1_channel1 = ShimmerValues_ECG1(3,:)';
ECG1_channel2 = ShimmerValues_ECG1(4,:)';
